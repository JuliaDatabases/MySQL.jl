...
function insert_values()
    ...
    values = [("John", [convert(Float32, 10000.50)], [convert(MYSQL_TIME, MySQLDate("2015-8-3"))],
               [convert(MYSQL_TIME, MySQLDateTime("2015-9-5 12:31:30"))],
               [convert(MYSQL_TIME, MySQLTime("12:00:00"))], [convert(Cchar, 1)],
               # [convert(Culong, 1)],
               [convert(Cshort, 1301)]),

              ("Tom", [convert(Float32, 20000.25)], [convert(MYSQL_TIME, MySQLDate("2015-8-4"))],
               [convert(MYSQL_TIME, MySQLDateTime("2015-10-12 13:12:14"))],
               [convert(MYSQL_TIME, MySQLTime("13:00:00"))], [convert(Cchar, 12)],
               # [convert(Culong, 1)],
               [convert(Cshort, 1422)]),

              ("Jim", [convert(Float32, 30000.00)], [convert(MYSQL_TIME, MySQLDate("2015-6-2"))],
               [convert(MYSQL_TIME, MySQLDateTime("2015-9-5 10:05:10"))],
               [convert(MYSQL_TIME, MySQLTime("12:30:00"))], [convert(Cchar, 45)],
               # [convert(Culong, 0)], 
               [convert(Cshort, 1567)]),

              ("Tim", [convert(Float32, 15000.50)], [convert(MYSQL_TIME, MySQLDate("2015-7-25"))],
               [convert(MYSQL_TIME, MySQLDateTime("2015-10-10 12:12:25"))],
